...
%% "openany" allows for chapters on odd pages, it would leave a blank page otherwise, there is a script to build correct double paged stacked booklets, also, md generator
